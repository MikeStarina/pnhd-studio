...
const AxisRotator = ({
  ...
  const tst = scale * 0.225;
  const points = React.useMemo(() => [new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, tst, 0), new THREE.Vector3(tst, tst, 0), new THREE.Vector3(tst, 0, 0), new THREE.Vector3(0, 0, 0)], [tst]);
  return React.createElement("group", {
    ...
    React.createElement("circleGeometry", null),
