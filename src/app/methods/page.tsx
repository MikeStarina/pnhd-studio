...
export const metadata: Metadata = {
    title: 'Методы печати на одежде в Санкт-Петербурге в ПИНХЭД СТУДИЯ',
    description: 'Методы нанесения принтов на одежду в ПИНХЭД СТУДИЯ. Печатаем любым способом: DTG, шелкография, термоперенос, вышивка.',
