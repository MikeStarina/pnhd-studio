    ...
    return (
        <main className={styles.page}>
            ...
            <section className={styles.section}>
                ...
                <img src={tee_classic_sizes} alt='size chart classic tee' className={styles.img} />
            </section>
            <section className={styles.section}>
                <h2 className={styles.section_title}>Футболки OVERSIZE</h2>
                <img src={tee_oversize_sizes} alt='size chart oversize tee' className={styles.img} />
            </section>
            <section className={styles.section}>
                <h2 className={styles.section_title}>Футболки PROMO</h2>
                <img src={tee_promo_sizes} alt='size chart promo tee' className={styles.img} />
            </section>
            <section className={styles.section}>
                <h2 className={styles.section_title}>Футболки GILDAN HAMMER</h2>
                <img src={tee_gildan_sizes} alt='size chart promo tee' className={styles.img} />
            </section>
            <section className={styles.section}>
                <h2 className={styles.section_title}>Худи CLASSIC</h2>
                <img src={hoodie_classic_sizes} alt='size chart classic hoodie' className={styles.img} />
            </section>
        </main>
    )
}
