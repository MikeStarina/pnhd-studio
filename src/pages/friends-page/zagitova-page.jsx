    ...
    <section className={styles.wrap}>
      ...
      <div className={styles.biography}>
        <div className={styles.biography_text}>
          <p>
            Алина Загитова родилась в 2002 году в Ижевске. С раннего детства
            она занималась фигурным катанием и уже тогда демонстрировала большие
          ...
          <p>
            ...
            В 2018 году она выиграла Чемпионат Европы и завоевала золотую и серебряную
            медаль на зимних Олимпийских играх, проходивших в Пхенчхане.
          </p>
          <p>
