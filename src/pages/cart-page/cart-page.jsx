    ...
    <section className={styles.screen}>
        ...
        {order && order.map((item) => {
          return (
            <li className={styles.cart_item} key={item.cart_item_id}>
              ...
              <Link to={{ pathname: `/shop/${item.attributes.slug}/constructor`, state: { state: item.cart_item_id, from: 'cart' } }}>link go to constructor</Link>
      ...
      <div className={styles.payment_info}>
        <div className={styles.payment_logo_wrapper}>
          <img src={kassa} alt="Юкасса" className={styles.payment_logo} />
          <img src={visa} alt="visa" className={styles.payment_logo} />
          <img
            src={Mastercard}
            alt="Mastercard"
            className={styles.payment_logo}
          />
          <img src={mir} alt="Мир" className={styles.payment_logo} />
        </div>
