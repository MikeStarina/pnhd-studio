export function getAllPrice(arr) {
  ...
  arr.forEach((element) => {
    ...
    const frontPrintPrice = element.print && element.print.front.file ? element.print.front.cartParams.price : 0;
    const backPrintPrice = element.print && element.print.back.file ? element.print.back.cartParams.price : 0;
    const lsleevePrintPrice = element.print && element.print.lsleeve.file ? element.print.lsleeve.cartParams.price : 0;
    const rsleevePrintPrice = element.print && element.print.rsleeve.file ? element.print.rsleeve.cartParams.price : 0;
