...
const ItemPrint = ({ print, title, qty, params, print_id, item_id }) => {
    ...
    return (
        ...
        <div className={styles.textile_description}>
            <button type='button' className={styles.delete_print_from_cart} id={item_id} name={print_id} onClick={deletePrintFromCart}>x</button>                           
