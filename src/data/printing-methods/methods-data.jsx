...
const methodsData = {
  ...
  silk: {
    ...
    price:
      'Цена зависит от размера, сложности рисунка и объема тиража. Pinhead Studio в Санкт-Петербурге предлагает печать шелкографией на футболках по выгодной цене от 1 штуки и гарантирует качество своих изделий. Создавайте уникальные дизайны и логотипы вместе с нами!',
    images: {
      main: silkMain,
