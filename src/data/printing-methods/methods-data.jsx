...
const methodsData = {
  ...
  silk: {
    ...
    price:
      'Цена зависит от размера, сложности рисунка и объема тиража. Studio Pinhead в Санкт-Петербурге предлагает печать шелкографией услуги шелкографии по выгодной цене от 1 штуки и гарантирует качество своих изделий. Создавайте уникальные дизайны и логотипы вместе с нами!',
    images: {
      main: silkMain,
