...
export const methodsData = {
  ...
  silk: {
    ...
    price: 'Цена зависит от размера, сложности рисунка и объема тиража. Studio Pinhead в Санкт-Петербурге предлагает услуги шелкографии по выгодной цене от 1 штуки и гарантирует качество своих изделий. Создавайте уникальные дизайны и логотипы вместе с нами!',
    images: {
      main: silkMain,
  ...
  dtf: {
    ...
    faq: {
      ...
      variants: [
        ...
        {
          screen_heading:
                        'Возможность создания полноцветных изображений:',
          screen_description:
