...
export const methodsData = {
  termo: {
    ...
    main_heading: "ТЕРМОТРАНСФЕРНАЯ ПЕЧАТЬ",
    brief_subtitle:
      "Термотрансферная печать (флекс) — отличный способ создать яркие, долговечные и высококачественные изображения на футболках. Studio Pinhead в Санкт-Петербурге предлагает услуги термотрансферной печати на футболках и другой одежде, заказать которые вы можете полностью онлайн на нашем сайте.",
    faq: {
      title: "Преимущества термотрансферной печати на футболках",
      variants: [
        {
          screen_heading: "Качество и долговечность",
          screen_description:
            "Термотрансферная печать обеспечивает высокое качество изображения с четкими деталями и яркими цветами. Печать прочно закрепляется на ткани, что делает ее стойкой к истиранию.",
        },
        {
          screen_heading: "Разнообразие дизайнов",
          screen_description:
            "С помощью термотрансферной печати вы можете создавать разнообразные дизайны, включая сложные графические элементы и, логотипы с одним или двумя цветами",
        },
        {
          screen_heading: "Оперативность",
          screen_description:
            "Термотрансферная печать идеально подходит для срочного нанесения плашечных одноцветных логотипов и изображений в небольших тиражах.",
        },
        {
  ...
  vishivka: {
    metaTitle: "Вышивка на футболках на заказ в Санкт-Петербурге от 1 штуки недорого в Studio Pinhead",
    metaKeywords: "вышивка на футболках, на заказ, санкт-петербург, логотип, черный, белый, оверсайз, заказать, надпись, 1 штука, стоимость, цена, текст, одежда, худи",
    metaDescription: "Заказать вышивку на футболке в Санкт-Петербурге можно недорого в нашей студии. Вышивка на футболках и другой одежде на заказ от 1 штуки по выгодной цене в Studio Pinhead.",
  ...
  silk: {
    metaTitle: "Шелкография на футболках в Санкт-Петербурге на заказ от 1 штуки цена в Studio Pinhead",
    metaKeywords: "шелкография на футболках, санкт-петербург, печать, цена, трафаретный, нанесение, 1, стоимость, сделать, одежда",
    metaDescription: "Сделать шелкографию на футболке в Санкт-Петербурге по выгодной цене в Studio Pinhead. Нанесение печати на футболки методом шелкографии от 1 штуки.",
    ...
    faq: {
      ...
      variants: [
        ...
        {
          screen_heading: "Виды трафаретной печати",
          screen_description: [
        ...
        },
        {
          ...
          screen_description: [
            `${point} высокая точность и детализация рисунка`,
    ...
    price:
      "Цена зависит от размера, сложности рисунка и объема тиража. Studio Pinhead в Санкт-Петербурге предлагает услуги шелкографии по выгодной цене от 1 штуки и гарантирует качество своих изделий. Создавайте уникальные дизайны и логотипы вместе с нами!",
    images: {
      main: silkMain,
  ...
  dtg: {
    metaTitle: "Прямая DTG печать на футболках в Санкт-Петербурге от 1 штуки цена в Studio Pinhead ",
    metaKeywords: "прямая печать на футболках, dtg, дтг, цифровой, санкт-петербург, одежда",
    metaDescription: "Прямая цифровая печать на футболках в Санкт-Петербурге по выгодной цене в Studio Pinhead. Заказать прямую DTG печать на одежде от 1 штуки онлайн на сайте.",
    main_heading: "ПРЯМАЯ ПЕЧАТЬ (DTG)",
    brief_subtitle:
      "Studio Pinhead в Санкт-Петербурге предлагает заказать печать на футболках с использованием одной из самых популярных технологий — DTG (Direct To Garment). ",
    faq: {
  ...
  dtf: {
    metaTitle: "DTF печать на футболках в Санкт-Петербурге от 1 штуки цена в Studio Pinhead ",
    metaKeywords: "dtf печать на футболках, дтф, пленка, термопленка, полноцветный, одежда, санкт-петербург",
    metaDescription: "Заказать DTF печать на футболке в Санкт-Петербурге по выгодной цене в Studio Pinhead. Полноцветная печать термопленкой на одежде от 1 штуки.",
    main_heading: "DTF печать",
    brief_subtitle:
    ...
    faq: {
      ...
      variants: [
        ...
        },
        {
          ...
          screen_description:
            "благодаря использованию нескольких цветов, можно создавать полноцветные изображения, которые выглядят очень эффектно и привлекательно.",
        },
      ],
      description: [
