...
export const typeOfPrintData = {
    numberAndSurname: {
        ...
        faq: {
            ...
            subtitle: [
                "На нашем сайте вы можете выбрать футболку, которую вы хотите использовать для печати. Мы предлагаем широкий выбор моделей разных цветов, размеров и стилей.",
                ...
                "После утверждения дизайна, начинается процесс печати. В производстве используются современное оборудование и качественные материалы, чтобы обеспечить высокое качество изделий. Вы можете быть уверены, что ваша фамилия и номер будут выглядеть ярко и четко на вашей футболке.",
        ...
        images: {
            // main: termoMain,
            gallery: [numberAndSurname1, numberAndSurname2, numberAndSurname3, numberAndSurname4, numberAndSurname5, numberAndSurname6],
        },
    },
    photo: {
        metaTitle:
    ...
    image: {
        ...
        faq: {
            ...
            subtitle: [
                ...
                "Обращайтесь в Studio Pinhead в Санкт-Петербурге, чтобы заказать печать принта на футболке и создать уникальный стиль одежды.",
            ],
            description: false,
        },
    ...
    logo: {
        ...
        faq: {
            ...
            subtitle: [
                        ...
                        "Мы используем все методы печати, каждый из которых имеет свои преимущества и недостатки, поэтому важно выбрать тот, который лучше всего подходит для вашего бизнеса.",
    ...
    inscriptions: {
        ...
        metaKeywords:
            "печать надписей на футболках, текст, санкт-петербург",
        metaDescription:
        ...
        faq: {
            ...
            variants: [
                ...
                },
                {
                    ...
                    screen_description:
                        "Основана на использовании трафаретов и специальных красок. Позволяет создавать яркие и четкие надписи, а также использовать различные цвета и текстуры.",
                },
                {
        ...
        images: {
            // main: dtfMain,
            gallery: [inscriptions1, inscriptions2, inscriptions3, inscriptions4, inscriptions5, inscriptions6],
        },
    },
};